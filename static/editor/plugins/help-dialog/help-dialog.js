...
(function() {
	...
	var factory = function (exports) {
		...
		exports.fn.helpDialog = function() {
			...
			{			
				var dialogContent = "<div class=\"markdown-body\" style=\"font-family:PingFang SC, Helvetica, Tahoma, STXihei,Arial;height:390px;overflow:auto;font-size:14px;border-bottom:1px solid #ddd;padding:0 20px 20px 0;\"></div>";
